...
layout(constant_id=12) const float boxWidth = 2;
layout(constant_id=13) const float boxHeight = 1;

// degrees
layout(constant_id=14) const float rotation = 0;

layout(constant_id=15) const float xOffset = 0;
layout(constant_id=16) const float yOffset = 0.5;
